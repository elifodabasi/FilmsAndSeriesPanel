...
export class SeriesComponent extends PagedListingComponentBase<FilmAndSeriesDtocs> {
    ...
    /**
     * Dizileri listelemek için yazıldı.
     * @param request
     * @param pageNumber
    ...
    list(
        ...
        this._filmAndSeriesServiceProxy
            .getSeries(request.skipCount, request.maxResultCount, request.keyword)
            .pipe(
                finalize(() => {
                    finishedCallback();
                })
